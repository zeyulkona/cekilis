...
if (!COOKIE_SECRET) {
  throw new Error('COOKIE_SECRET env değişkeni tanımlı olmalı.');
}
...
// If an admin ever clicks an outbound link from an admin page, don't leak
// the current (secret) URL to the destination site via the Referer header.
